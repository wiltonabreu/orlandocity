...
<html>
	...
	<body>
		<header>
			<div id="menu-mobile-mask" class="d-none d-xs-block">



			</div>

			<div id="menu-mobile" class="d-none d-xs-block">
			...
			<div class="header-black">
				...
				<div class="container">
					...
					<input type="search" id="input-search-mobile" class="d-none d-xs-block" placeholder="search...">
