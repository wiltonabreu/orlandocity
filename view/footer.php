...
<script src="lib/owlcarousel2/dist/owl.carousel.min.js"></script>	<footer>
							...
							<div class="row row-cols">
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<address class="d-none d-sm-block">
										<i class="fa fa-map-marker"></i><span>Av. Vicente Simões, 235, São José, Belo Horizonte - MG.</span>
									</address>

									<p class="d-none d-sm-block"><a href="tel:9.95343423"><i class="fa fa-phone"></i>  9.95343423</a></p>
			...
			<div class="row row-cinza-escuro">
				...
				<div class="container copyright-mobile" >
					...
					<p class="text-right text-roxo"> Created by HCODE Udemy</p>
				</div>
