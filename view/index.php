...
<section>
	...
	<div id="call-to-action">
		...
		<div class="container">
			...
			<div class="row text-center">
				<h2>American club number on in Brazil<hr></h2>
				
			</div>

			<div class="row">
				<p>
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium earum, ratione aut, quod, distinctio sint, recusandae laboriosam sequi doloribus quidem beatae! A debitis repellendus aut mollitia quisquam ipsa, tempore at!
				</p>
			</div>
